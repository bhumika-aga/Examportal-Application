...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(UserService userService, CategoryService categoryService, QuizService quizService,
                           QuestionService questionService, BCryptPasswordEncoder bCryptPasswordEncoder) {
